...
public:
    ...
    void loadShader()
    {        
        string psBlendFragShader = "#version 120\n \
        ...
        ";
        psBlendShader.setupShaderFromSource(GL_FRAGMENT_SHADER, psBlendFragShader);
	...
	void draw(ofTexture& blendTgt, int blendMode = 0, int x = 0, int y = 0)
    {
		psBlendShader.begin();
